...
import com.example.test_task_followers.databinding.FragmentAuthBinding
import com.example.test_task_followers.ui.viewmodels.AuthViewModel
import com.example.test_task_followers.utils.launchAndCollectIn
import com.example.test_task_followers.utils.toast
...
class AuthFragment : Fragment(R.layout.fragment_auth) {
    ...
    private fun bindViewModel() {
        ...
        viewModel.authSuccessFlow.launchAndCollectIn(viewLifecycleOwner) {
            findNavController().navigate(AuthFragmentDirections.actionAuthFragmentToUserSearchFragment())
        }
    }
